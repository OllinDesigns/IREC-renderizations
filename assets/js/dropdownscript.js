document.addEventListener("DOMContentLoaded", function () {
  ...
  var structure = {
    Experimental: {
      ...
      // Experimental6
      "Activation Energy": {
        iframe: "visualizations/experimental/6_Exp_ActivationEnergy.html",
        csv: "data/experimental/6_Exp_ActivationEnergy.csv",
      },

      // Experimental7
      "Preexponential Factor": {
        iframe: "visualizations/experimental/7_Exp_PreexponentialFactor.html",
    ...
    "Machine Learning Model": {
      //MLM1
      "Surface Exchange Coefficient": {
        iframe: "visualizations/model/9_MLM_SurfaceExchangeCoefficient.html",
        csv: "data/model/9_MLM_SurfaceExchangeCoefficient.csv",
      },

      //MLM2
      "Oxygen Diffusion Coefficient": {
        iframe: "visualizations/model/10_MLM_OxygenDiffusionCoefficient.html",
        csv: "data/model/10_MLM_OxygenDiffusionCoefficient.csv",
      },

      //MLM3
      "Activation Energy": {
        iframe: "visualizations/model/11_MLM_ActivationEnergy.html",
        csv: "data/model/11_MLM_ActivationEnergy.csv",
      },

      //MLM4
      "Preexponential Factor": {
        iframe: "visualizations/model/12_MLM_PreexponentialFactor.html",
        csv: "data/model/12_MLM_PreexponentialFactor.csv",
      },

      //MLM5
      "Area Specific Resistance at 600ºC": {
        iframe: "visualizations/model/13_MLM_AreaSpecificResistance600.html",
        csv: "data/model/13_MLM_AreaSpecificResistance600.csv",
      },

      //MLM6
      "Area Specific Resistance at 700ºC": {
        iframe: "visualizations/model/14_MLM_AreaSpecificResistance700.html",
